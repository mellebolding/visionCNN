...
# Usage:
#   ./scripts/run_imagenet_ecoset_resnet_ecovalid_aug.sh
#   NGPUS=1 ./scripts/run_imagenet_ecoset_resnet_ecovalid_aug.sh
...
NGPUS="${NGPUS:-3}"
CONFIG_DIR="configs/imagenet_ecoset_resnet_ecovalid_aug"
NORMS=(batchnorm layernorm groupnorm rmsnorm derf)
...
echo "============================================"
echo "ImageNet-Ecoset136 ResNet50 Eco-Valid Aug Norm Experiment"
...
echo "============================================"
echo "All resnet imagenet_ecoset136 eco-valid aug runs complete!"
echo "============================================"
