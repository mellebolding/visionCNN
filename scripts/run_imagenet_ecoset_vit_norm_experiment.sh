#!/bin/bash
# Run ViT-Small norm experiment on ImageNet-Ecoset136 (no augmentation).
# Direct comparison to ResNet50 and ConvNeXt norm experiments (same dataset).
#
# Norms: batchnorm, layernorm, groupnorm, rmsnorm, derf
# Usage:
#   ./scripts/run_imagenet_ecoset_vit_norm_experiment.sh
#   NGPUS=1 ./scripts/run_imagenet_ecoset_vit_norm_experiment.sh
...
NGPUS="${NGPUS:-3}"
CONFIG_DIR="configs/imagenet_ecoset_vit_norm_experiment"
NORMS=(batchnorm layernorm groupnorm rmsnorm derf)
...
echo "============================================"
echo "ImageNet-Ecoset136 ViT Norm Experiment"
...
echo "============================================"
echo "All vit imagenet_ecoset136 runs complete!"
echo "============================================"
